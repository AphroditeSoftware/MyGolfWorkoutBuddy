...
#ifndef MYGOLFWORKOUTBUDDY_WATCH_APP_SWIFT_H
#define MYGOLFWORKOUTBUDDY_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MyGolfWorkoutBuddy_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC28MyGolfWorkoutBuddy_Watch_App14WorkoutManager")
...
@class NSDate;
@interface WorkoutManager (SWIFT_EXTENSION(MyGolfWorkoutBuddy_Watch_App)) <HKWorkoutSessionDelegate>
...
@class HKSampleType;
@interface WorkoutManager (SWIFT_EXTENSION(MyGolfWorkoutBuddy_Watch_App)) <HKLiveWorkoutBuilderDelegate>
